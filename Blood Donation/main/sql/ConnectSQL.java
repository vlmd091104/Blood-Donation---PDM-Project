...
public class ConnectSQL {
        ...
        try {
            ...
            try (Connection connection = DriverManager.getConnection(connectionString)){
                ...
                if(userType.equals("donor")){
                    String sql = "Select top 1 ID from DonorPassword order by ID desc";
    ...
    public static void addPassword(String userType, int ID, String user, String  password){
        try {
            ...
            try (Connection connection = DriverManager.getConnection(connectionString)){
                if(userType.equals("donor")){
                    String sql = "Insert into DonorPassword (ID, userName, password) values (?, ?, ?)";
    ...
    public static boolean isValid(String userType, String user, String password){
        try {
            ...
            try (Connection connection = DriverManager.getConnection(connectionString)){
                if(userType.equals("donor")){
                    String sql_1 = "Select ID from DonorPassword where Cast(userName as nvarchar(max)) = ? and Cast(password as nvarchar(max)) = ?";
                    ...
                    if(rs_1.next()){
                        ...
                        String sql_2 = "Select Concat(firstName,' ', lastName) as name from Donor where ID = ?";
                    ...
                    if(rs_1.next()){
                        int ID = rs_1.getInt("ID");
                        String sql_2 = "Select Concat(firstName,' ', lastName) as name from Staff where ID = ?";
                        PreparedStatement pStmt_2 = connection.prepareStatement(sql_2);
    ...
    public static boolean addData(String userType, int ID, String firstName, String lastName, String doB , String gender, String email, String phone, String address, String role){
        try {
            ...
            try (Connection connection = DriverManager.getConnection(connectionString)){
                if(userType.equals("donor")){
                    String sql = "Insert into Donor (ID, firstName, lastName, DateOfBirth, gender, email, phone, address) values (? ,? ,? ,? ,? ,? ,? ,?)";
                    PreparedStatement pStmt = connection.prepareStatement(sql);
                    pStmt.setInt(1, ID);
                    ...
                    String sql = "Insert into Staff (ID, firstName, lastName, email, phone, address, role) values (? ,? ,? ,? ,? ,? ,?)";
                    PreparedStatement pStmt = connection.prepareStatement(sql);
                    pStmt.setInt(1, ID);
                    pStmt.setString(2, firstName);
                    pStmt.setString(3, lastName);
    ...
    public static boolean updateData(String userType, int ID, String firstName, String lastName, String doB , String gender, String email, String phone, String address, String role){
        try {
            ...
            try (Connection connection = DriverManager.getConnection(connectionString)){
                if(userType.equals("donor")){
                    String sql = "Update Donor set firstName = ?, lastName = ?, DateOfBirth = ?, gender = ?, email = ?, phone = ?, address = ? where ID = ?";
                    PreparedStatement pStmt = connection.prepareStatement(sql);
                    pStmt.setInt(8, ID);
                    ...
                    String sql = "Update Staff set firstName = ?, lastName = ?, email = ?, phone = ?, address = ?, role = ? where ID = ?";
                    PreparedStatement pStmt = connection.prepareStatement(sql);
                    pStmt.setInt(7, ID);
                    pStmt.setString(1, firstName);
                    pStmt.setString(2, lastName);
        ...
        try {
            ...
            try (Connection connection = DriverManager.getConnection(connectionString)){
                if(password.isEmpty()){
                    ...
                    if(userType.equals("donor")){
                    String sql = "Update DonorPassword set password = ? where ID = ?";
                    PreparedStatement pStmt = connection.prepareStatement(sql);
