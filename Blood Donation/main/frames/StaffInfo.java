...
public class StaffInfo extends StaffSignUp{
    ...
    public StaffInfo(){
        ...
        this.data = ConnectSQL.loadData("staff", HomeStruct.getID());
        
        super.setData(data.get(0), data.get(1), data.get(2), data.get(3), data.get(4));
        this.tfRole.setText(data.get(5));
        ...
        this.btUpdate.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(confirm == JOptionPane.YES_OPTION){
                    ...
                    if(ConnectSQL.updateData("staff", HomeStruct.getID(),tfFirstName.getText(), tfLastName.getText(), null, null, tfEmail.getText(), tfPhone.getText(), tfAddress.getText(), tfRole.getText())){
